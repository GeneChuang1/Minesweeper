...
public class TileClicked_Recursive {
    ...
    private void recursiveReveal(int row, int column) {
        ...
        boolean hasBeenRevealedByHintButton;
        ...
        if (revealedValue == 0) {  //If it's a blank tile.
            ...
            if (clColumn >= 0) {  //Boundary check.
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[clRow][clColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
            ...
            if (crColumn <= 7) {  //Board's Boundary Check
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[crRow][crColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed ||hasBeenRevealedByHintButton) {
            ...
            if (tlRow >= 0 && tlColumn >= 0) { //Boundary Check
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[tlRow][tlColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
            ...
            if (tcRow >= 0) {
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[tcRow][tcColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
            ...
            if (trRow >= 0 && trColumn <= 7) {  //Boundary Check
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[trRow][trColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
            ...
            if (blRow <= 7 && blColumn >= 0) {  //Boundary Check
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[blRow][blColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
            ...
            if (bcRow <= 7) { //Boundary Check
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[bcRow][bcColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
            ...
            if (brRow <= 7 && brColumn <= 7) {  //Board's boundary check
                ...
                hasBeenRevealedByHintButton = MinesweeperGame.gameBoard[brRow][brColumn].getWasRevealedByHintButton();
                if (hasNotBeenRevealed || hasBeenRevealedByHintButton) {
    ...
    private int reveal(int row, int column) {
        ...
        if (MinesweeperGame.gameBoard[row][column].getNumSurroundingBombs() == 0) {
            ...
            MinesweeperGame.gameBoard[row][column].setWasRevealedByHintButton(false);
            return 0;
